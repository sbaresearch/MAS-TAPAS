...
attacks = [tapas.attacks.DOMIASAttack(density_estimator="prior", label="DOMIAS_PRIOR1"),
           tapas.attacks.DOMIASAttack(density_estimator="kde"),
           tapas.attacks.DOMIASAttack(density_estimator="bnaf", verbose=1)]
summaries = []
...
for attack in attacks:
    ...
    # Evaluate the attack.
    print(f"Evaluating {attack.label}...")
    summaries.append(threat_model.test(attack, num_samples=5))
